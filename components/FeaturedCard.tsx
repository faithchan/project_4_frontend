...
const FeaturedCard = () => {
    return (
        ...
        <div className="">
          <div className="w-72 p-8 bg-purple opacity-80 rounded-3xl ">
            ...
            <div className="mt-4">
              ...
              <div className="  flex justify-between ">
                <button className="block text-sm font-body font-semibold text-gray-300 cursor-auto">0.01 Eth</button>
