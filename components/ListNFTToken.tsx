        ...
        <div className="w-full  max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg  bg-white">
            <div className="">
                ...
                <div className="grid grid-cols-1 mx-7">
                    <input className="bg-gray-100 text-gray-800 border border-gray-400 px-4 py-2 outline-none rounded-md mt-2" type="text" placeholder="0.01 Eth" />
                    ...
                    <div className="relative inline-block mt-2 w-10 mr-2 align-middle select-none transition duration-200 ease-in">
                        ...
                        <input className="bg-gray-100 text-gray-800 border border-gray-400 px-4 py-2 outline-none rounded-md mt-2" type="number" min="0.01" placeholder="0.01 Eth" />
                    </div>
                </div>
                <div className="p-3 mt-2 text-center space-x-4 md:block">
                    <button className="mb-2 md:mb-0 bg-white px-5 py-2 text-xs shadow-sm font-header tracking-wider border text-gold rounded-full hover:shadow-lg hover:bg-gray-100" onClick={(e)=>{e.preventDefault();props.setListModal(false)}}>
                        List Later
                    </button>
