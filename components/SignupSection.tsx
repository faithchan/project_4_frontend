    ...
    return (
        <div>
          <div className="flex my-20 justify-center">
                ...
                <p className="font-body text-sm mb-6 text-gray-300 leading-normal tracking-wide">A platform for verified designers to showcase and sell NFTs.<br/> Sign up now and get connected with our growing network. </p>
