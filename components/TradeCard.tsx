...
const TradeCard = () => {
    return (
        <div>
            <div className="w-full p-8 bg-purple opacity-80 rounded-3xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all transform duration-500 ">
              ...
              <p className="text-gold mt-4 text-md font-header tracking-widest">SILO</p>
              </span>
